...
- Using the decimal system, we can say that a number is just the sum of each digit in base 10, ie, each digit is multiplied by 10 to the index of the digit (starting from 0 on the right)
	- For example, 6083 can be expressed as: 
$$ 
6083 = 6 \cdot 10^3 + 0 \cdot 10^2 + 8 \cdot 10^1 + 3 \cdot 10^0
$$
...
![figure_2.2](../../assets/figure_2.2.png)

![Pasted image 20230802135543](../../assets/Pasted%20image%2020230802135543.png)
### Full Adder
...
![Pasted image 20230802135649](../../assets/Pasted%20image%2020230802135649.png)
...
![figure_2.4](../../assets/figure_2.4.png)
...
![figure_2.5a](../../assets/figure_2.5a.png)

![figure_2.5b](../../assets/figure_2.5b.png)
